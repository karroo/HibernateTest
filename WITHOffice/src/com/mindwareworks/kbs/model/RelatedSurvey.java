...
public class RelatedSurvey implements java.io.Serializable {
	...
	private Set<SurveyParticipation> surveyParticipations = new HashSet<SurveyParticipation>(
			0);
	...
	/** full constructor */
	public RelatedSurvey(RelatedSurveyId id, Content content,
			Question question, Integer startTime, Integer endTime,
			Set<SurveyParticipation> surveyParticipations) {
		this.id = id;
		this.content = content;
		this.question = question;
	...
	public void setSurveyParticipations(
			Set<SurveyParticipation> surveyParticipations) {
		this.surveyParticipations = surveyParticipations;
	}
